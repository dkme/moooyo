...
namespace Moooyo.WebUI.Models
{
    public class MemberDisplayObj
    {
        ...
        public BiZ.Comm.UniqueNumber.UniqueNumber UniqueNumber; //增强的唯一编号
        ...
        #region  用户徽章
        public IList<BiZ.Member.MemberBadge> Badgelist;
        #endregion
        ...
        #region 设置信息
        public BiZ.Member.FansGroupName FansGroupName;
