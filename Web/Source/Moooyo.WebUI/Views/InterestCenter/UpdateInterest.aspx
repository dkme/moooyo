    ...
    <div class="container">
        <div class="box_demo1 w680 fb_left">
            ...
            <div class="Set_title2 border_b1 p40">
                <img src="/pics/edit_group.gif" width="51" height="51" /><span style="font-size: 22px">修改兴趣群组
                    <font class="cgray">（拍了照片，抓紧秀出来）</font></span><a class="com_back blue02" onclick="history.back()">返回</a>
            </div>
            <div class="Set_box1 p40" style="padding: 40px; padding-top: 20px;">
                ...
                <div class="one_step">
                    ...
                    <div class="fb_box_com w600">
                        <div class="step_01_l">
                            <span class="step_pic">
                                <img src="<%=Comm.getImagePath(Model.interestObj.ICONPath, ImageType.Middle) %>" title="美女"
                                    height="148" width="148" id="imgInterestIconPreview"></span>
                ...
                <div class="two_step">
                    ...
                    <p class="step-cnt">
                        <% string selfhoodPicture = Model.interestObj.SelfhoodPicture;
                           selfhoodPicture = (selfhoodPicture != null && selfhoodPicture != "") ? Comm.getImagePath(selfhoodPicture, ImageType.Original) : "/pics/step_bg2.gif"; %>
                        <img class="placeholder" src="<%=selfhoodPicture %>" id="imgInterestSelfhoodPicturePreview"
                            width="450" height="141" /></p>
                    <p class="tipText">
                        图片上传后显示在这里，选择的图片宽应大于等于800像素，高应大于等于250像素，可以是jpg、gif、png或bmp格式，单张图片不超过8MB</p>
                    <form action="/Shared/UploadTempCustomPhoto" method="post" enctype="multipart/form-data"
                    id="frmInterestSelfhoodPicture" name="frmInterestSelfhoodPicture">
                ...
                <div class="third_step">
                    ...
                    <div class="fb_box_com w600">
                        <div class="from_add">
                            <span>
                                <input type="text" name="txtTitle" id="txtTitle" value="<%=Model.interestObj.Title %>"
                                    class="txtput" /></span> <span>
                                        <textarea name="txtContent" id="txtContent" class="textarea3" style="width: 350px;
                                            height: 80px;"><%=Model.interestObj.Content %></textarea></span>
                            <span>
                                <input type="text" name="txtClasses" id="txtClasses" value="<%=Model.interestObj.Classes %>"
                                    class="txtput select_xq" />
                                ...
                                </span><span class="Prese_btn"><a class="redlink" onclick="modifyInterest()">保 存</a><a
                                    href="/InterestCenter/ShowMyInterest" class="graylink">取 消</a></span>
                        </div>
                    </div>
                </div>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function modifyInterest() {
            ...
            if (frmInterest.valid()) {
                interestCenterProvider.modifyInterest(
                    interestId,
                    $("#txtTitle").val(),
                    $("#txtContent").val(),
                    $("#txtClasses").val(),
                    ...
                    function (data) {
                        ...
                        if (result.ok) {
                            $.jBox.tip("更新成功", 'info');
                            window.location.href = "/Content/IndexContent/" + interestId + "/all/all/1";
                        }
                        else {
