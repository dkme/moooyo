 ...
 <div class="box_title"><a href="/Content/TaContent/<%=Model.contentobj.Creater.MemberID %>/all/1" target="_blank"><%=Model.contentobj.Creater.NickName%></a><%=Model.typename %></div>
                ...
                <div class="info_left">
                    <div style="padding:10px 20px; line-height:25px;">
                        <img src="<%=Comm.getImagePath(interest.Interest.ICONPath,ImageType.Middle) %>" width="45" height="45" style="float:left; margin-right:10px;"/><span style="color:#A5a5a5; float:left;">刚刚创建兴趣</span><br /><span style="color:#0099cc; overflow:hidden;"><%=interest.Interest.Title%></span>
                    </div>
