    ...
    <div class="box_demo1 fb_left">
      <div class="box_left2" >
        ...
        <div class="Set_title1 border_b1 p40">
            <span class="large_font">晒心情</span>
        ...
        <div class="Set_box1 p40" style="padding:40px;padding-top:20px;">
            ...
            <%Html.RenderAction("ImageUploadascx", "Content", new { ifShowUp = true, contentTitle = "心情" }); %>
...
<script type="text/javascript">
    ...
    function contentsubmit() {
        ...
        if (interestIDs == "") {
            ...
            $.jBox.tip("请选择一个心情类型", 'error');
        }
        else if (content == "") {
            $.jBox.tip("请填写心情", 'error');
        }
        else if (imagecount > 1 != "" && imageLayOutType == "") {
            $.jBox.tip("请选择一个照片布局类型", 'error');
        }
        else {
            ContentProvider.InsertMoodContent(permissions, interestIDs, content, imageIDs, imageLayOutType, type, function (data) {
