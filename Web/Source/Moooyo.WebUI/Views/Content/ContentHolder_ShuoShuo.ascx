...
<div class="box_title"><a href="/Content/TaContent/<%=Model.contentobj.Creater.MemberID %>/all/1" target="_blank"><%=Model.contentobj.Creater.NickName%></a><%=Model.typename%></div>
                ...
                <div class="info_left">
                   <%-- <h3 class="h3 hleft"><img src="/pics/left_marks.gif"></h3>--%>
                    <span class="h80" style="overflow:hidden; padding:0px 10px;"><%=suosuo.Content%></span>
                  <%--  <h3 class="h3 hright"><img src="/pics/right_marks.gif"></h3>--%>
                    ...
                    <%int i = 0;
                      ...
                      {
                          if (i > 6) { break; }%>
                        <a href="/Content/TaContent/<%=obj.MemberID %>/all/1" id="activityMemberInfo" target="_blank"><img src="<%=Comm.getImagePath(obj.MemberIcon,ImageType.Middle) %>" height="25" width="25"></a>
                        <%i++;
                      } %>
                    </span>
                </div>
