    ...
    <div class="box_demo1 fb_left">
      <div class="box_left2" >
        ...
        <div class="Set_title1 border_b1 p40">
            <span class="large_font">新说说</span>
            <font class="cgray" >（有新想法？想要吐槽？或是又有什么感悟？没关系，写吧，我全给你兜着。）</font>
        </div>
        <div class="Set_box1 p40" style="padding:40px;padding-top:20px;">
            <%Html.RenderAction("AddContentType", "Content", new { contentType = Moooyo.BiZ.Content.ContentType.SuiSuiNian, contentObj = Model.contentObj != null ? Model.contentObj : null }); %>
            <%Html.RenderAction("ImageUploadascx", "Content", new { ifShowUp = false, contentTitle = "说说内容", photoType = 202, contentObj = Model.contentObj != null ? Model.contentObj : null }); %>
...
<%if (Model.contentObj != null)
  {
      Moooyo.BiZ.Content.SuiSuiNianContent callfor = (Moooyo.BiZ.Content.SuiSuiNianContent)Model.contentObj;
      %>
...
<script type="text/javascript">
    ...
    function contentsubmit() {
        ...
        if (interestIDs == "") {
            ...
            var updateContent = $("#updateContent");
            if (updateContent.val() != null) {
                ContentProvider.InsertSuiSuiNianContent(permissions, interestIDs, content, imageIDs, imageLayOutType, type, updateContent.val(), function (data) {
                ...
                ContentProvider.InsertSuiSuiNianContent(permissions, interestIDs, content, imageIDs, imageLayOutType, type, "", function (data) {
                    var data = $.parseJSON(data);
                    if (data != null) {
