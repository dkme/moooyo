...
namespace Moooyo.BiZ.Content
{
    ...
    public class CallForContent : PublicContent
    {
        private String content;//号召内容
        ...
        public CallForContent() { }
        public CallForContent(String MemberID, ContentPermissions ContentPermissions, List<String> InterestID, String Content, List<Image> ImageList, ImageLayoutType LayOutType, String Type)
        {
            
            PublicContent obj = new PublicContent(MemberID, ContentPermissions, InterestID, ContentType.CallFor);
        ...
        public CallForContent(String contentID)
        {
            try
            {
                CallForContent obj = new CallForContent();
                MongoCollection<CallForContent> mc = MongoDBHelper.MongoDB.GetCollection<CallForContent>(PublicContent.GetCollectionName());
        ...
        /// 号召内容的添加或更新
        /// </summary>
        /// <param name="obj">号召内容对象</param>
        /// <returns>添加或更新操作是否成功</returns>
        public CallForContent Save(CallForContent obj)
        {
            try
            {
