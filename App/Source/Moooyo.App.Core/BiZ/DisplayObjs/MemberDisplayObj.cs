...
namespace Moooyo.App.Core.BiZ.DisplayObjs
{
    public class MemberDisplayObj
    {
        ...
        public Core.BiZ.Comm.UniqueNumber.UniqueNumber UniqueNumber; //增强的唯一编号
        ...
        #region  用户徽章
        public IList<Core.BiZ.Member.MemberBadge> Badgelist;
        #endregion
        ...
        #region 用户兴趣列表
        public IList<Core.BiZ.InterestCenter.Interest> InterestList;
        #endregion

        #region 设置信息
        public Core.BiZ.Fans.FansGroupName FansGroupName;
