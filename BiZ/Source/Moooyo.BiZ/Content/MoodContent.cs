...
namespace Moooyo.BiZ.Content
{
    ...
    public class MoodContent : PublicContent
    {
        ...
        public MoodContent() { }
        public MoodContent(String MemberID, ContentPermissions ContentPermissions, List<String> InterestID, String Content, List<Image> ImageList, ImageLayoutType LayOutType, String Type)
        {
            PublicContent obj = new PublicContent(MemberID, ContentPermissions, InterestID, ContentType.Mood);
        ...
        public MoodContent(String contentID)
        {
            try
            {
                MoodContent obj = new MoodContent();
                MongoDatabase md = MongoDBHelper.MongoDB;
                MongoCollection<MoodContent> mc = md.GetCollection<MoodContent>(MoodContent.GetCollectionName());
        ...
        /// 心情内容的添加或更新
        /// </summary>
        /// <param name="obj">心情内容对象</param>
        /// <returns>添加或更新操作是否成功</returns>
        public MoodContent Save(MoodContent obj)
        {
            try
            {
                MongoDatabase md = MongoDBHelper.MongoDB;
                MongoCollection<MoodContent> mc = md.GetCollection<MoodContent>(PublicContent.GetCollectionName());
                mc.Save(obj);
                //审核关键字
