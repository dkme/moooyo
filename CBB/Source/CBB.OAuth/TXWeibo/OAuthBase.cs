    ...
    public class oAuthBase
        {
            ...
            public string OAuth_CallBack { set { oauth_callback = value; } }
            ...
            public virtual string GenerateNonce()
            {
                ...
                string strs = "1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";
                Random rnd = new Random();
                string ret = "";
                for (int i = 0; i < 32; i++)
                {
                    ret += strs.Substring(rnd.Next(strs.Length), 1);
                }
                return ret;
