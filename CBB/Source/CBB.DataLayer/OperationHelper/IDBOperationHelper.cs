...
namespace NESCBB.DataLayer
{
    ...
    public class IDBOperationHelper
    {
        ...
        public static IDbConnection GetIDbConnection(string ConnectionStr)
        {
            ...
            {
                throw new Exception("NESCBB.Datalayer.IDBOperationHelper.GetIDbConnection 无法检测连接字符串的数据库类型！");
            }
        ...
        public static IDbTransaction f_开始IDbTransaction()
        {
        ...
        public static IDbTransaction f_开始IDbTransaction(String ConnectionStr)
        {
        ...
        public static void f_回滚IDbTransaction(IDbTransaction st)
        {
            if (st != null)
            {
                try
        ...
        public static int f_调用无反回(String sql)
        {
            try
            {
        ...
        public static int f_调用无反回(String sql, CommandType commaneType, String ConnectionStr)
        {
            try
            {
                if (GetDBType(ConnectionStr) == OperationDBType.OLEDB)
        ...
        public static int f_调用无反回(String sql, IDbDataParameter[] sp, CommandType commaneType, String ConnectionStr)
        {
            try
            {
                if (GetDBType(ConnectionStr) == OperationDBType.OLEDB)
        ...
        public static int f_调用无反回(IDbTransaction st, String sql, IDbDataParameter[] sp, CommandType commaneType, bool AllComplete)
        {
            if (st == null)
            {
                throw new Exception("本方法调用需要传入一个有效的事务，本次调用传入事务为Null");
        ...
        public static object f_调用读取单一对象(String sql)
        {
            try
            {
                if (GetDBType(Comm.ConnectionStr) == OperationDBType.OLEDB)
        ...
        public static object f_调用读取单一对象(String sql, CommandType commaneType, String ConnectionStr)
        {
            try
            {
                if (GetDBType(ConnectionStr) == OperationDBType.OLEDB)
        ...
        public static object f_调用读取单一对象(String sql, IDbDataParameter[] sp, CommandType commaneType, String ConnectionStr)
        {
            try
            {
                if (GetDBType(ConnectionStr) == OperationDBType.OLEDB)
        ...
        public static object f_调用读取单一对象(IDbTransaction st, String sql, bool AllComplete)
        {
            if (st == null)
            {
                throw new Exception("本方法调用需要传入一个有效的事务，本次调用传入事务为Null");
        ...
        public static IDataReader f_读取DataReader(String sql)
        {
        ...
        public static IDataReader f_读取DataReader(IDbTransaction st, CommandType commaneType, String sql)
        {
            IDataReader myr = null;
        ...
        public static IDataReader f_读取DataReader(IDbTransaction st, CommandType commaneType, String sql, IDbDataParameter[] sp)
        {
            IDataReader myr = null;
        ...
        public static IDataReader f_读取DataReader(String sql, CommandType commaneType, String connectionStr)
        {
            IDataReader myr = null;
            try
            {
        ...
        public static IDataReader f_读取DataReader(String sql, IDbDataParameter[] sp, CommandType commaneType, String connectionStr)
        {
            IDataReader myr = null;
            try
            {
        ...
        public static DataSet f_读取DataSet(String sql)
        {
            DataSet myr = null;
            try
            {
        ...
        public static DataSet f_读取DataSet(IDbTransaction st, CommandType commaneType, String sql)
        {
            DataSet myr = null;
            if (st == null)
            {
        ...
        public static DataSet f_读取DataSet(IDbTransaction st, CommandType commaneType, String sql, IDbDataParameter[] sp)
        {
            DataSet myr = null;
        ...
        public static DataSet f_读取DataSet(String sql, CommandType commaneType, String connectionStr)
        {
            DataSet myr = null;
            try
            {
        ...
        public static DataSet f_读取DataSet(String sql,IDbDataParameter[] sp, CommandType commaneType, String connectionStr)
        {
            DataSet myr = null;
            try
            {
